...
export function TestimonialsSection() {
  return (
    <section className="relative mx-auto max-w-7xl px-6 pt-10 pb-14 md:pt-14 md:pb-20 lg:px-8">
      ...
      <div className="grid gap-6 sm:grid-cols-3">
        {TESTIMONIALS.map((t, i) => (
          <ScrollReveal key={t.author + i} delay={i * 90}>
            <Card className="h-full gap-0 rounded-2xl border border-white/10 bg-gradient-to-b from-brand-navy-card to-[color-mix(in_oklch,var(--color-brand-navy),black_30%)] py-0 text-white shadow-2xl ring-0 transition-all duration-300 hover:-translate-y-1.5 hover:shadow-[0_35px_60px_-20px_rgba(0,0,0,0.6)]">
